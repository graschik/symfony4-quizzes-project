 ...
 */
class Version20180401182658 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users ADD is_remember TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users DROP is_remember');
    }
}
