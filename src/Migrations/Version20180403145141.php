 ...
 */
class Version20180403145141 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users DROP verified, DROP token, DROP roles');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users ADD verified INT DEFAULT NULL, ADD token VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD roles JSON NOT NULL COMMENT \'(DC2Type:json_array)\'');
