 ...
 */
class Version20180403145701 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users ADD token VARCHAR(255) NOT NULL, ADD verified INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users DROP token, DROP verified');
    }
}
