 ...
 */
class Version20180403163458 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users DROP verified');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users ADD verified INT DEFAULT NULL');
    }
}
